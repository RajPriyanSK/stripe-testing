...
export function PricingCard({
  ...
  return (
    ...
    >
      ...
      <div
        className={cn('bg-muted/20 rounded-t-lg border-b p-4', plan.highlighted && 'bg-muted/40')}
      >
      ...
      <div
        className={cn('text-muted-foreground space-y-4 px-4 py-6 text-sm', plan.highlighted && 'bg-muted/10')}
      >
            ...
            <TooltipProvider>
              <Tooltip delayDuration={0}>
                <TooltipTrigger asChild>
                  <p
                    className={cn(feature.tooltip && 'cursor-pointer border-b border-dashed')}
                  >
                    {feature.text}
                  </p>
                </TooltipTrigger>
